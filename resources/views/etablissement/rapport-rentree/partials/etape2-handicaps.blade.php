<!-- Handicaps -->
<div id="handicaps" class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
    <h3 class="text-xs font-semibold text-gray-700 mb-3 flex items-center uppercase tracking-wide">
        <i class="fas fa-wheelchair text-gray-500 mr-2 text-xs"></i>
        Élèves en Situation de Handicap
    </h3>
    
    <p class="text-xs text-gray-500 mb-4 italic">
        <i class="fas fa-info-circle text-blue-500 mr-1"></i>
        Recensez les élèves en situation de handicap par type, niveau et sexe.
    </p>
    ...
    $handicapTypes = [
        ...
        'handicap_sourd_muet' => 'Handicap Sourd/Muet',
        'handicap_deficience_intel' => 'Déficience Intellectuelle'
    ];
    @endphp
    
    <div class="space-y-4">
        @foreach($handicapTypes as $type => $label)
