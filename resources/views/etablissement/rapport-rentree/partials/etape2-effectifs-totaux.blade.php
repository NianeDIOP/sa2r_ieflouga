<!-- Effectifs Totaux -->
<div id="effectifs-totaux" class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
    <h3 class="text-xs font-semibold text-gray-700 mb-3 flex items-center uppercase tracking-wide">
        ...
        Effectifs Totaux par Niveau
    </h3>
    
    <p class="text-xs text-gray-500 mb-4 italic">
        <i class="fas fa-info-circle text-blue-500 mr-1"></i>
        Renseignez le nombre d'élèves par sexe. Le total se calcule automatiquement (Garçons + Filles).
    </p>
            ...
            <div class="border border-gray-200 rounded-lg p-3 bg-gray-50">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div>
                        ...
                        <input type="number" 
                               name="effectifs[{{ $niveau }}][effectif_garcons]"
                               value="{{ $data->effectif_garcons ?? '' }}"
                               data-section="effectifs"
                               data-niveau="{{ $niveau }}"
                               data-category="effectif"
                               onchange="calculateEffectifTotal(this, 'effectif'); autoSave('effectifs')"
                               min="0"
                               placeholder="Nombre"
                    ...
                    <div>
                        ...
                        <input type="number" 
                               name="effectifs[{{ $niveau }}][effectif_filles]"
                               value="{{ $data->effectif_filles ?? '' }}"
                               data-section="effectifs"
                               data-niveau="{{ $niveau }}"
                               data-category="effectif"
                               onchange="calculateEffectifTotal(this, 'effectif'); autoSave('effectifs')"
                    ...
                    <div>
                        ...
                        <input type="number" 
                               name="effectifs[{{ $niveau }}][effectif_total]"
                               value="{{ $data->effectif_total ?? '' }}"
                               data-niveau="{{ $niveau }}"
                               data-total-for="effectif"
                               readonly
